...
import numpy as np
import torch
from compactreasoningmodels.solving_traces.arc_consistency import (
    ArcConsistency,  # type: ignore[import-untyped]
)
from compactreasoningmodels.solving_traces.discrete_genetic import (
    DiscreteGeneticAlgorithm,  # type: ignore[import-untyped]
)
from compactreasoningmodels.solving_traces.global_min_violations import (
    GlobalMinViolations,  # type: ignore[import-untyped]
)
from compactreasoningmodels.solving_traces.local_min_violations import (
    LocalMinViolations,  # type: ignore[import-untyped]
)
from compactreasoningmodels.solving_traces.model_solver import (
    ModelSolver,  # type: ignore[import-untyped]
)
