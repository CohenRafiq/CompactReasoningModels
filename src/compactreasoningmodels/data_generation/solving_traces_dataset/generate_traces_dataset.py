...
SAMPLING_RATIO_RUNS = [(1.0, 1), (0.75, 5), (0.5, 5)]
...
def main():
    ...
    output_path = os.path.join(os.environ["DATA_DIR"], "traces/genetic.jsonl")
    ...
    with open(output_path, "w") as f:
        for i, (X, y, padding_mask, X_raw, y_raw, meta) in enumerate(dataloader):
            ...
            for solver_name, solver_class in TEMP_SOLVERS.items():
                solver = solver_class()
                solver_dict = {}
                ...
                for sampling_ratio, number_of_samples in SAMPLING_RATIO_RUNS:
                    ...
                    for _ in range(number_of_samples):
                        steps, cr_losses, mse_losses, num_steps, solved, step_ratio = solver.try_solve(
